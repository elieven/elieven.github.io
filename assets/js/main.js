...
document.addEventListener("DOMContentLoaded", function() {
  ...
  if (!isMobile) {
    ...
    var desktopScrollbar = OverlayScrollbars(
    ...
    window.onpopstate = function() {
      desktopPopStateHandler(desktopScrollbar);
    };
  } else {
    cl("Detected desktop device");
    ...
    mobileScrollBackToTopBtnShowHandler(
      ScrollTopBtnOptions.scrollTopBtnElement,
      ScrollTopBtnOptions.showThreshold
    );
...
function desktopScrollBackToTopBtnHandler(desktopScrollbar) {
  if (ScrollTopBtnOptions.scrollTopBtnElement != null) {
    ScrollTopBtnOptions.scrollTopBtnElement.addEventListener(
      "click",
      function() {
